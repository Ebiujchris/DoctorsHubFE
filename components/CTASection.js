        ...
        <div className="max-w-3xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <button
              ...
              className="px-8 py-4 bg-indigo-700 text-white rounded-lg font-semibold hover:bg-indigo-800 border-2 border-white transition-colors"
            >
              Sign In
            </button>
          </div>
          ...
          {/* Trust Badges */}
          <div className="mt-12 pt-8 border-t border-indigo-400">
            <p className="text-indigo-100 mb-6">Trusted by over 100,000+ users</p>
            <div className="flex justify-center items-center gap-8 flex-wrap">
              <div className="text-center">
                <p className="text-3xl font-bold mb-2">10K+</p>
                <p className="text-indigo-100 text-sm">Doctors</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-bold mb-2">100K+</p>
                <p className="text-indigo-100 text-sm">Patients</p>
              </div>
              <div className="text-center">
